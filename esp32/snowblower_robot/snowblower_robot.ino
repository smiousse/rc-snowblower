...
// Robot motor pins
#define ML_Ctrl 12  //define direction control pin of left motor controller DIG1
#define ML_PWM 32   //define PWM control pin of left motor controller pin AN1
#define MR_Ctrl 14  //define direction control pin of right motor controller DIG2
#define MR_PWM 33    //define PWM control pin of right motor controller pin AN2
